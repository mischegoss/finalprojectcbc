...
export default class DataSheet_sheet2 extends DataSheetBase {
  ...
  makeDefaultItems() {
    ...
    item['img_Name'] = "Meron Langsner";
    item['document_key'] = "35mtadSqoB3LSTdpilgP";
    item['img_Number'] = "";
    item['img_URL'] = "https://lh3.googleusercontent.com/-f5qKphn3cmM/AAAAAAAAAAI/AAAAAAAADIo/_aE15t-Z8Bw/photo.jpg";
    item.key = key++;
    
    item = {};
    this.items.push(item);
    item['img_Name'] = "Tamar Auber";
    item['document_key'] = "lPRpLpBbbBy0Pgpizi7F";
    item['img_Number'] = "";
